...
class ALU {
  ...
  public y: number = 0;
  public z: number = 0;
  public inp(fn: (x: () => number) => {}, get: () => number) {
    fn(get);
  }
  public add(fn: (x: () => number) => {}, get: () => number) {
    fn(get);
  }
  public mul(fn: (x: () => number) => {}, get: () => number) {
    fn(get);
  }
  public div(fn: (x: () => number) => {}, get: () => number) {
    fn(get);
  }
  public getW() {
    return this.w;
  ...
  public addZ(value: () => number) {
    this.z += value();
  }
  public mulW(value: () => number) {
    this.w *= value();
  }
  public mulX(value: () => number) {
    this.x *= value();
  }
  public mulY(value: () => number) {
    this.y *= value();
  }
  public mulZ(value: () => number) {
    this.z *= value();
  }
  public divW(value: () => number) {
    this.w = Math.floor(this.w / value());
  }
  public divX(value: () => number) {
    this.x = Math.floor(this.x / value());
  }
  public divY(value: () => number) {
    this.y = Math.floor(this.y / value());
  }
  public divZ(value: () => number) {
    this.z = Math.floor(this.z / value());
  }
  public modW(value: () => number) {
    this.w = this.w % value();
  }
  public modX(value: () => number) {
    this.x = this.x % value();
  }
  public modY(value: () => number) {
    this.y = this.y % value();
  }
  public modZ(value: () => number) {
    this.z = this.z % value();
  }
  public eqlW(value: () => number) {
    this.w = this.w === value() ? 1 : 0;
  }
  public eqlX(value: () => number) {
    this.x = this.x === value() ? 1 : 0;
  }
  public eqlY(value: () => number) {
    this.y = this.y === value() ? 1 : 0;
  }
  public eqlZ(value: () => number) {
    this.z = this.z === value() ? 1 : 0;
  }
  ...
  public getOperation(op: string, register: string): Operator {
    switch (op) {
      case "inp":
        switch (register) {
          case "w":
            return this.setW.bind(this);
          case "x":
            return this.setX.bind(this);
          case "y":
            return this.setY.bind(this);
          case "z":
            return this.setZ.bind(this);
          default:
      ...
      case "add":
        switch (register) {
          case "w":
            return this.addW.bind(this);
          case "x":
            return this.addX.bind(this);
          case "y":
            return this.addY.bind(this);
          case "z":
            return this.addZ.bind(this);
          default:
            throw new Error(`${op} : ${register} unexpected register`);
        }
      case "mul":
        switch (register) {
          case "w":
            return this.mulW.bind(this);
          case "x":
            return this.mulX.bind(this);
          case "y":
            return this.mulY.bind(this);
          case "z":
            return this.mulZ.bind(this);
          default:
            throw new Error(`${op} : ${register} unexpected register`);
        }
      case "div":
        switch (register) {
          case "w":
            return this.divW.bind(this);
          case "x":
            return this.divX.bind(this);
          case "y":
            return this.divY.bind(this);
          case "z":
            return this.divZ.bind(this);
          default:
            throw new Error(`${op} : ${register} unexpected register`);
        }
      case "mod":
        switch (register) {
          case "w":
            return this.modW.bind(this);
          case "x":
            return this.modX.bind(this);
          case "y":
            return this.modY.bind(this);
          case "z":
            return this.modZ.bind(this);
          default:
            throw new Error(`${op} : ${register} unexpected register`);
        }
      case "eql":
        switch (register) {
          case "w":
            return this.eqlW.bind(this);
          case "x":
            return this.eqlX.bind(this);
          case "y":
            return this.eqlY.bind(this);
          case "z":
            return this.eqlZ.bind(this);
          default:
            throw new Error(`${op} : ${register} unexpected register`);
        }
      default:
...
class Instruction {
  constructor(public op: Operator, public value: Supplier) {}
}
class InstructionBuilder {
  public op: Operator;
  public value: Supplier;
  constructor(public line: string, public alu: ALU, public input: Supplier) {
    // inp w
    // mul x 0
    // add x z
    // mod x 26
  ...
  getSupplier(value: string) {
    switch (value) {
      case "w":
        return this.alu.getW.bind(this.alu);
      case "x":
        return this.alu.getX.bind(this.alu);
      case "y":
        return this.alu.getY.bind(this.alu);
      case "z":
        return this.alu.getZ.bind(this.alu);
      default:
...
class Program {
  ...
  constructor(public lines: string[]) {
    this.instructions = lines.map((line) =>
      new InstructionBuilder(line, this.alu, this.nextInput.bind(this)).get(),
    );
  }
  public nextInput() {
    return this.input();
...
const part1 = (rawInput: string) => {
  ...
  for (var prog of input) {
    ...
    console.log(
      `prune :${prune.toFixed(0).padStart(20)} ${(elapsed() / 1000)
        .toFixed(3)
        .padStart(10)}s  ${(Math.round(used * 100) / 100)
        .toFixed(2)
        .padStart(8)} MB ${Object.keys(zMap).length.toFixed(0).padStart(10)}`,
    );
    zMap = {};
    for (var i = 9; i > 0; i--) {
