...
class InstructionBuilder {
  ...
  constructor(public input: string) {
    ...
    switch (matches[1]) {
      case "forward":
        this.instruction = new Forward(value);
        break;
      case "down":
        this.instruction = new Down(value);
        break;
      case "up":
        this.instruction = new Up(value);
        break;
      default:
        throw new Error("unrecognised input");
    }
...
class Submarine {
  constructor(public position: Position, public instructions: Instruction[]) {}
